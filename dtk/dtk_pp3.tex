...
Die letzte Zeile ist der Maßstab.  Der Vorgabewert dafür ist
...
Flamsteed-Nummer.  Für sehr südliche Sternbilder, die Herr Flamsteed von London
...
äquidistante Projektion.  Sie stellt einen Kompromiss zwischen Winkel- und
Flächentreue dar und ist in der Astronomie sehr beliebt.  \PPthree\ dreht das
Zentrum jeder Karte in den Zenit der Projektion (Punkt geringster Verzerrung)
und kann daher immer die bestmögliche Abbildung bieten.
...
Arbeitseinsatz angeht: Fast alle Skripte sind eher einfacher als das
